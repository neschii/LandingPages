        ...
        <DropdownMenu>
            <DropdownMenuTrigger>
                 <div className="flex gap-2 items-center">
                    ...
                    <div className="flex text-pink-200 justify-center items-center rounded-full overflow-hidden w-10 h-10 p-1 bg-purple-900" aria-label={props.usuario.nome}>
                        <IconUserSquareRounded stroke={2}/>
                    </div>
                </div>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
