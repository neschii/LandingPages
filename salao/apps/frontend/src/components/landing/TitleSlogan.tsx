...
export default function TitleSlogan() { 
    return ( 
 <div className="px-8 relative h-[920px]">
            <Image src="/banners/salaobg.jpg" fill alt="Salão" className="object-cover" />
            <div className="
                    flex flex-col items-center
                    absolute top-0 left-0 w-full h-full
                    bg-black/80 md:bg-transparent md:bg-gradient-to-r bg-gradient-to-r from-indigo-500/50 via-purple-500/50 to-pink-500/50"
            >
            <Menu />  
            <div className="container flex-1 flex flex-col justify-center items-center gap-2 z-50">
                 <h1 className="flex flex-col items-center">
                        ...
                        <span className="text-purple-900 border-black text-4xl sm:text-xl= md:text-xl lg:text-7xl font-black">
                            Transforme-se
                        </span>
                    </h1>
